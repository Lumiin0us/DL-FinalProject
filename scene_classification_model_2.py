...
mobileNetV2_model = torch.load('/Users/abdurrehman/Desktop/DL-FinalProject/DL-FinalProject/mobileNetV2_model.pth')

# mobileNetV2_model = model_checkpoint['model']
...
#     nn.Linear(mobileNetV2_model.fc.in_features, 512),
#     nn.ReLU(),
#     nn.Dropout(p=0.4),
...
optimizer = optim.SGD(mobileNetV2_model.parameters(), lr=0.001, weight_decay=0.001, momentum=0.9)
...
train_nn(mobileNetV2_model, train_dataloader, test_dataloader, loss_function, optimizer, 100)
